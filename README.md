...
- Кэширование - _Redis_.
- Резервная копия База Данных - _Celery Beat_.
- Отправка сообщений на почту - _Celery_.
- Брокер очередей или \`Журнал\` - _RabbitMQ_ / _Kafka_ **(в разработке)**.
...
1. _Почта_:
    ...
    - Проверка на копию.
    - Сообщение о создании пользователя (_Celery_).
    - Сообщение об активации пользователя
2. _Пароль_:
    - Проверка на корректность.
    - Проверка на копию.
    - Сброс пароля.
