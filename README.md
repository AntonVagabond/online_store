...
## 📃 Содержание ##
1. ✏️ [Описание проекта](#-описание-проекта-)
   - 📋 [Задачи](#-задачи-)
   - 📟 [Функциональные возможности](#-функциональные-возможности-)
2. 📱 [Технологии проекта](#-технологии-проекта-)
3. 📚 [Используемые зависимости](#-используемые-зависимости-)
4. 📈 [Связи между таблицами](#-связи-между-таблицами-)
5. 🔌 [Установка и запуск](#-установка-и-запуск-)
   - 📔 [Установка проекта в IDE](#-установка-проекта-в-ide-)
   - 🐳 [Установка проекта в Docker](#-установка-проекта-в-docker)
...
- Резервная копия Базы Данных - `Celery Beat`.
...
> Если на вашем компьютере **есть** всё ниже перечисленное, то можете _пропустить_
> это предупреждение.
